...
let rockNode = document.querySelector(".rock");
let rock = rockNode.cloneNode(true);

let paperNode = document.querySelector(".paper");
let paper = paperNode.cloneNode(true);

let scissorsNode = document.querySelector(".scissors");
let scissors = scissorsNode.cloneNode(true);
...
function displayGameOver() {
  ...
  uiMessage.appendChild(resetButton);
}

function resetGame() {
  userScore = 0;
  computerScore = 0;
  uiMessage.removeChild(resetButton);
